export default [
    {
        slug:'react-web-player',
        title:'React Web Player',
        description: 'React Web Player it s a browser based Music Player, it s connected to a database and a CDN, so you can upload your own music and listen it anywhere ',
        photos: ['https://i.imgur.com/WEnshAG.png', 'https://i.imgur.com/pyN5Jxz.png', 'https://i.imgur.com/i138Lxg.png'],
